...
void write_inode_table(int fd) {
	...
	hello_link_inode.i_block[0] = 0x6C6C6568;
	hello_link_inode.i_block[1] = 0x6F772D6F;
	hello_link_inode.i_block[2] = 0x00646C72;
...
void write_hello_world_file_block(int fd)
{
	...
	u32 content[3] = {0x6C6C6548, 0x6F77206F, 0x0A646C72};
	write(fd, content, 12);
}
